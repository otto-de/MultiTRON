...
from src.evaluate import (calculate_ranks, mean_metric, pointwise_mrr, pointwise_recall, validate_batch_per_timestamp)


def test_pointwise_recall():
    ranks = tensor([[1., 0., float('inf')], [0., 1., 1.], [2., 2., 1.]])

    mask = tensor([[1., 1., 1.], [1., 1., 0.], [0., 0., 0.]])
...
def test_pointwise_recall_per_timestamp():
    logits = tensor([[5., 6., 7., 1.], [5., 6., 7., 1.], [5., 6., 7., 1.]])
...
def test_calculate_ranks():
    ...
    labels = tensor([[1, 2, 3], [2, 1, 0], [0, 0, 0]])

    cutoffs = tensor([1, 3]).int()

    expected_ranks = tensor([[1., 0., float('inf')], [0., 1., 1.], [2., 2., 1.]])
...
def test_pointwise_mrr():
    ...
    expected = tensor([[[0., 1., 0.], [1., 0., 0.], [0., 0., 0.]], [[.5, 1., 0.], [1., .5, 0.], [0., 0., 0.]]])
    assert equal(pointwise_mrr(ranks, cutoffs, mask), expected)


def test_mean_mrr():
    mrr_matrix = tensor([[[0., 1., 0.], [1., 0., 0.], [0., 0., 0.]], [[.5, 1., 0.], [1., .5, 0.], [0., 0., 0.]]])
...
def test_validate_batch_per_timestamp():
    x_hat = torch.tensor([[[0.1, 0.2, 0.3, 0.4], [0.1, 0.2, 0.3, 0.4], [0.1, 0.2, 0.3, 0.4]],
                          [[0.1, 0.2, 0.3, 0.4], [0.1, 0.2, 0.3, 0.4], [0.1, 0.2, 0.3, 0.4]]])
    output_embedding = torch.nn.Embedding(100, 4)

    batch = {
        'click_labels': torch.tensor([[1, 2, 0], [1, 2, 0]]),
        'mask': torch.tensor([[0., 1., 1.], [1., 1., 1.]]),
        'order_labels': torch.tensor([[0., 1., 1.], [1., 1., 1.]])
    }
